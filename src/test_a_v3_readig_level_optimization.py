...
# ============================================================
# A‑v3 TRANSFORMATION PROMPT (Stabilized Reading Level)
# ============================================================
...
- Do NOT remove steps unless they are non-essential
...
print("="*70)
print("TEST A-v3: READING LEVEL OPTIMIZATION (STABILIZED)")
print("="*70)
print("\n")
...
print("="*70)
print("TEST A-v3 SUMMARY: READING LEVEL OPTIMIZATION")
print("="*70)
