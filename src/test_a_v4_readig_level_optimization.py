...
# ============================================================
# A‑v4 TRANSFORMATION PROMPT (Stabilized, No Dignity Layer Yet)
# ============================================================
...
- Use short, clear sentences (8–14 words each)
- Everyday words only (no medical terms unless unavoidable)
- Keep ALL essential actions and warnings
- Do NOT remove steps unless they are clearly non-essential
- Do NOT merge multiple steps into one sentence
- Use clear adult language (avoid phrases like “feel very sick” or “rest your body”)
- No added information, no assumptions

CONTENT FLOOR:
Each section must contain at least 4 sentences.
...
print("="*70)
print("TEST A-v4: READING LEVEL OPTIMIZATION (STABILIZED)")
print("="*70)
print("\n")
...
print("="*70)
print("TEST A-v4 SUMMARY: READING LEVEL OPTIMIZATION")
print("="*70)
