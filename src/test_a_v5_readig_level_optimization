...
# ============================================================
# A‑v5 TRANSFORMATION PROMPT (Stabilized, No Dignity Layer Yet)
# ============================================================
...
- Use clear adult language, but simple words
- Avoid complex phrases like “potential side effects” or “specific recommendations”
- No added information, no assumptions

CONTENT FLOOR:
Each section must contain 5–7 sentences.
...
print("="*70)
print("TEST A-v5: READING LEVEL OPTIMIZATION (STABILIZED)")
print("="*70)
print("\n")
...
print("="*70)
print("TEST A-v5 SUMMARY: READING LEVEL OPTIMIZATION")
print("="*70)
