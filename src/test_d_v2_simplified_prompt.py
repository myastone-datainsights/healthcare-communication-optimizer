"""
Test D-v2: Simplified Prompt + No Stage 1 Parser
...
SCENARIO_NAME = "Hip Surgery"
BASELINE_GRADE = 9.5  # CHANGE: 9.5, 9.6, 10.2, 9.7, 8.6

CLINICAL_INPUTS = {
    "Hip Surgery": """Post-operative total hip arthroplasty discharge protocol:
